...
function PaymentSuccessPage() {
 ...
 <div className="payment-icon" style={{ background: '#f3f4f6', color: '#6b7280', margin: '0 auto 24px' }}>
 
 </div>
 <p style={{ color: '#6b7280', fontSize: '1rem' }}>Se verifică plata...</p>
 <p style={{ color: '#9ca3af', fontSize: '0.88rem', marginTop: '8px' }}>Nu închide această pagină.
 </p>
 </div>
 )}
 ...
 <h1 style={{ color: '#16a34a', marginBottom: '12px' }}>Plată reușită!</h1>
 <p style={{ color: '#374151', fontSize: '1.05rem', marginBottom: '8px' }}>Rezervarea ta este acum <strong>confirmată</strong>.
 </p>
 <p style={{ color: '#6b7280', fontSize: '0.9rem', marginBottom: '32px' }}>Ai primit un email de confirmare.
 {bookingId && <> · Rezervare <strong>#{bookingId}</strong></>}
 </p>

 <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
 <Link to="/my-bookings" className="btn-primary">Vezi rezervările mele
 </Link>
 ...
 <h1 style={{ color: '#991b1b', marginBottom: '12px' }}>Problemă la plată</h1>
 <p style={{ color: '#374151', fontSize: '1.05rem', marginBottom: '32px' }}>
 {errorMsg}
 </p>
 <Link to="/my-bookings" className="btn-primary">Înapoi la rezervări
 </Link>
 </>
 )}
