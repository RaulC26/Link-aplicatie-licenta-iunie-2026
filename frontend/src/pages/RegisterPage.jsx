...
function RegisterPage() {
 ...
 <div
 style={{ width: '100%', height: '100%', backgroundImage: 'url("/logo fotrez transparent.png")', backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}
 />
 </div>
 <div className="auth-logo-text">fotrez
 ...
 <p className="auth-tagline">Alătură-te<br />
 <span>comunității noastre.</span>
 </p>
 <p className="auth-tagline-sub">Creează un cont gratuit și ai acces imediat la toate terenurile de fotbal din platformă.
 </p>
 ...
 <p>Înregistrarea e gratuită, plătești doar rezervările efectuate.</p>
 </div>
 </li>
 <li className="auth-feature-item">
 ...
 <p className="auth-form-sub">Durează mai puțin de 1 minut. Nu sunt necesare date bancare.</p>
 <RegisterForm />
 </div>
 </div>
 </div>
