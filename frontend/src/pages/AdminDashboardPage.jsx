...
function AdminDashboardPage() {
 ...
 <p style={{ margin: 0, fontSize: '0.88rem', color: '#94a3b8' }}>Gestionează terenuri, rezervări, utilizatori și turnee
 </p>
 </div>
 </div>
 </div>
 ...
 <button className={activeTab === 'fields' ? 'admin-tab active' : 'admin-tab'} onClick={() => setActiveTab('fields')}>
 <MapPin size={15} strokeWidth={2.5} /> Terenuri
 </button>
 <button className={activeTab === 'bookings' ? 'admin-tab active' : 'admin-tab'} onClick={() => setActiveTab('bookings')}>
 <CalendarDays size={15} strokeWidth={2.5} /> Rezervări
 </button>
 <button className={activeTab === 'users' ? 'admin-tab active' : 'admin-tab'} onClick={() => setActiveTab('users')}>
 <Users size={15} strokeWidth={2.5} /> Utilizatori
 </button>
 <button className={activeTab === 'tournaments' ? 'admin-tab active' : 'admin-tab'} onClick={() => setActiveTab('tournaments')}>
