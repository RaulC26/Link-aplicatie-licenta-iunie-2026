...
function LoginPage() {
 ...
 <p className="auth-tagline">Rezervă rapid și ușor<br />
 <span>terenul tău preferat.</span>
 </p>
 <p className="auth-tagline-sub">Platforma pasionaților de fotbal pe sintetic.
 </p>
 ...
 <p>Alege ziua, ora și confirmă instant fără apeluri telefonice.</p>
 </div>
 </li>
 <li className="auth-feature-item">
 ...
 <p className="auth-form-sub">Intră în cont pentru a rezerva terenuri și a te înscrie la turnee.</p>
 <LoginForm />
 </div>
 </div>
 </div>
