  ...
  return (
    <div className="page-container">
      <div className="payment-result-card">
        ...
        <p
          style={{ color: "#374151", fontSize: "1.05rem", marginBottom: "8px" }}
        >
        ...
        >
          Rezervarea ta rămâne în status <strong>"Așteaptă plata"</strong>și o
          poți plăti oricând din secțiunea "Rezervările mele".
