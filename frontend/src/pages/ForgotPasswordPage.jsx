...
function ForgotPasswordPage() {
 ...
 if (!res.ok) { setError(data.mesaj || 'Eroare la trimiterea cererii.'); return }
 setSuccess(data.mesaj || 'Dacă există un cont cu acest email, vei primi un link de resetare.')
 setEmail('')
 } catch {
 ...
 <p className="auth-form-sub">Te ajutăm să recapeți accesul la contul tău.</p>
