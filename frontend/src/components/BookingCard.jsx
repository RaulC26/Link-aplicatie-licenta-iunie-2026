...
function BookingCard({ booking, onCancel }) {
  ...
  const isBookingInPast =
    ...
    (bookingDateStr === todayStr && bookingStart <= currentHHMM);
    ...
    <>
      ...
      >
        ...
        <div className="booking-card-details">
          <p>
            <MapPin size={14} strokeWidth={2.5} /> {booking.field_location}
          </p>
          <p>
            <CalendarDays size={14} strokeWidth={2.5} /> {formattedDate}
          </p>
          <p>
            <Clock size={14} strokeWidth={2.5} /> {booking.start_time} —{" "}
            {booking.end_time}
          </p>
          <p className="booking-price">
            <Banknote size={14} strokeWidth={2.5} /> {booking.total_price} lei
          </p>
        </div>

        <div className="booking-card-actions">
          {isPastUnpaid && (
            <span className="booking-expired-label">Plată expirată</span>
          )}
